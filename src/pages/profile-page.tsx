    ...
    return (
        <div>
            ...
            <div className="pt-[24px] md:space-y-[25px] space-y-[15px] md:p-[40px] p-[12px]">
                <h1 className="md:text-[32px] text-[24px] font-bold">Профиль</h1>
                <p className="md:text-[18px] text-[14px] font-bold">Учётная запись</p>
                ...
                {loadingCurrentUser && <Skeleton className="w-full h-[220px]" />}
                <p className="md:text-[18px] text-[14px] font-bold">Доверенные лица</p>
                <Card>
